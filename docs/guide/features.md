...
- Supports the upstream `CapacityBuffer` API when `settings.featureGates.capacityBuffer=true`, enabling proactive provisioning and replenishment of spare node capacity.
